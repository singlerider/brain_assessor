from classifier.game.choicegame import ChoiceGame, Choice
from classifier.game.quesgame import QuesGame
import json
...
class DictionaryGame(QuesGame, ChoiceGame):
    ...
    def __init__(self, width=700, height=550):
        ...
        # load after gamesettings as gameTime is not a game variable for this
        # game
        self.gameTime = self.numQuestions

        choice_y = self.lblQuestion.y - 80
        self.choice1 = Choice('Choice 1', 0, self.width // 2 - 100, choice_y)
        self.choice2 = Choice('Choice 2', 1, self.width //
                              2 - 100, choice_y - 60)
        self.choice3 = Choice('Choice 3', 2, self.width //
                              2 - 100, choice_y - 120)
        self.choice4 = Choice('Choice 4', 3, self.width //
                              2 - 100, choice_y - 180)
...
def loadDictionary():
    ...
    '''
    fname = 'classifier/resources/dictionary_minimal.json'
